  ...
  return (
    <div>
      <header className='flex py-2 px-6 sm:px-6 justify-between place-items-center'>
          ...
          <Link to={'/myEvents'}> {/*TODO:Route myEvents page after creating it */}
          ...
          {!!user &&(
            ...
            {/* TODO: */}
              <nav className={`block ${isMenuOpen ? 'block' : 'hidden'} `}>
                ...
                <Link className="flex hover:bg-background hover:shadow py-2 pl-6 pr-8 rounded-lg" to={'/notifications'}>
